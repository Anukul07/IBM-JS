...
personType = prompt("Which one are you ? Employee or Enrolled Member or Subscriber or a Non-Subscriber?")
...
switch(personType){
    case "Employee":
        ...
        break;
    case "Subscriber":
        console.log("You are authorized to have partial access to Dietary Servics")
        break;
    case "Non-Subscriber":
